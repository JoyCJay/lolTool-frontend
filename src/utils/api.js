...
export function getMatchList(accountId){
  return http.get(`http://localhost:9090/consult/getMatchList?accountId=${accountId}`)
  // return [
  //       {
  //           "platformId": "EUW1",
  //           "gameId": 3996539685,
...
export function getRedList(gameId){
  return http.get(`http://localhost:9090/consult/getRedList?gameId=${gameId}`)
  // return [
  //   {
  //     index:0,
  //     id: "red1",
...
export function getBlueList(gameId){
  return http.get(`http://localhost:9090/consult/getBlueList?gameId=${gameId}`)
  // return [
  //   {
  //     index:0,
  //     id: "blue1",
...
export function getMatch(matchId) {
  return http.get(`http://localhost:9090/consult/getMatch?matchId=${matchId}`)
}